...
var hotels = [
  ...
  },
  {
    ...
    cost: 3455,
    address:
      "177/1/A,Sadesatara Nali,Amanora Park Town, Magarpatta Road, Hadapsar.pune",
    type: [
      {
        roomtype: "1",
        name: "Deluxe Room",
  ...
  },
  {
    ...
    cost: 5170,
    address:
      "Chhatrapati Shivaji Sports Complex, Pune-Bangalore Highway, Hinjewadi, Pune",
    type: [
      {
        roomtype: "3",
        name: "Budget Room",
  ...
  },
  {
    ...
    cost: 2419,
    address:
      "Kadamba Plateau, Panjim Old Goa Bypass Road, Velha Goa, Panaji,Tiswadi Goa",
    type: [
      {
        roomtype: "1",
        name: "Deluxe Room",
  ...
  },
  {
    ...
    cost: 4000,
    address:
      "Asset 5-A, Hospitality District, Aerocity, IGI Airport , New Delhi",
    type: [
      {
        roomtype: "1",
        name: "Deluxe Room",
  ...
  },
  {
    ...
    cost: 5170,
    address:
      "Janakpuri, District Centre Complex, Near Janak Puri West Metro Station",
    type: [
      {
        roomtype: "3",
        name: "Budget Room",
